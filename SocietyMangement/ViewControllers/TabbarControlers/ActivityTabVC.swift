...
class ActivityTabVC: BaseVC , addSingleDate , addMultiDate , addDeliveryMultiDate, addLeaveNoteGuard  {
    ...
    @IBOutlet weak var btndateOpen: UIButton!
  ...
  // var activityGroupAry = [UserActivityType]()
   ...
   //  tabBarItem = UITabBarItem(title: "Activity", image: UIImage(named: "ic_activity_selected"), selectedImage: UIImage(named: "ic_activity_unselected"))
    ...
    override func viewWillAppear(_ animated: Bool) {
       ...
       /* self.collectionActivity.dataSource = self
        ...
        if selectedindex != nil {
            let userAct = String(format: "%d", selectedindex!)
    ...
    @IBAction func btnDelivery(_ sender: UIButton) {
      ...
      //  apicallGuestListbtnDelivery() // 2
    }
    
    @IBAction func btnCab(_ sender: UIButton) {
        filtrview.isHidden = true

      //  apicallGuestListbtnCab() // 3
    }
...
//        toolbar.tintColor = UIColor.black
    ...
    @objc func dateChanged(_ sender: UIDatePicker?) {
        ...
        if let date = sender?.date {
            ...
            strDateSet = dateFormatter.string(from: date)
    ...
    @objc func onDoneButtonClick() {
        ...
        strDateSet = formatter.string(from: datePicker.date)
...
//        ]
  ...
  /*  @objc func aceeptRequest(sender:UIButton) {
   ...
   /* func apicallOutMember(strGaurdID:String,strRequestId:String,outTime:String,userTye:String,strbuildingID:String,strflatID:String,strType:String)
    ...
    func strChangeDateFormate_Multi(strDateeee: String) -> String
        {
            let dateFormatter = DateFormatter()
            dateFormatter.dateFormat = "yyyy-MM-dd"
            let date = dateFormatter.date(from: strDateeee)
...
extension ActivityTabVC: UICollectionViewDelegate , UICollectionViewDataSource, UICollectionViewDelegateFlowLayout
{
    ...
    func alertShow() {
        // popOverConfirmVC.isfrom
        
       /* var msg = ""
        
        if isfromNo == 1 { // Visitor
            msg = "Entry Updated Successfully"
        }else if isfromNo == 2 { // Delivery
            msg = "Entry Updated Successfully"
        }else if isfromNo == 3 { // Cab_Service
            msg = "Entry Updated Successfully"
        }else if isfromNo == 4 { // onDemenad
            msg = "Entry Updated Successfully"
        }else{
            msg = "Entry Updated Successfully"
        } */
        
        let alert = UIAlertController(title: "", message: "Entry Updated Successfully", preferredStyle: .alert)
        self.present(alert, animated: true, completion: nil)
        Timer.scheduledTimer(withTimeInterval: 4.0, repeats: false, block: { _ in alert.dismiss(animated: false, completion: nil)})
    ...
    @objc func ApiCallDeliveryInfo(sender:UIButton) {
        ...
        popOverConfirmVC.strAllowed = "Approved by " + (arrGuestList[sender.tag].activity?.approvedBy)!
        
        popOverConfirmVC.strAdded = "Added by " + (arrGuestList[sender.tag].activity?.addedBy)!

        popOverConfirmVC.strPhone = (arrGuestList[sender.tag].activity?.phone!)!
        
        popOverConfirmVC.strVehicle = (arrGuestList[sender.tag].activity?.vehicle!)!
    ...
    @objc func ApiCallEdit(sender:UIButton)
    {
       ...
       filtrview.isHidden = true
        ...
        if self.arrGuestList[sender.tag].activity?.ActivityType! == "Visitor Entry" {
                ...
                popOverConfirmVC.isfrom = isfromNo // 1
            ...
            if arrGuestList[sender.tag].activity?.isMulti == "0" { // single
               ...
               if (arrGuestList[sender.tag].activity?.activityIn) != nil {
                ...
                if (arrGuestList[sender.tag].activity?.activityIn) != nil {
                  ...
                  //  let lblin = arrGuestList[sender.tag].activity?.activityIn!
                   
                    let strIn = strChangeDateFormate_Multi(strDateeee: lblin!)
                ...
                if (arrGuestList[sender.tag].activity?.out) != nil {
                   ...
                   // let lblout = arrGuestList[sender.tag].activity?.out!
                    
                    let strOut = strChangeDateFormate_Multi(strDateeee: lblout!)
            ...
            popOverConfirmVC.isfrom = isfromNo  // 3
    ...
    @objc func ApiCallRenew(sender:UIButton)
    {
        ...
        if self.arrGuestList[sender.tag].activity?.ActivityType! == "Visitor Entry" {
               ...
               if (arrGuestList[sender.tag].activity?.activityIn) != nil {
                ...
                if (arrGuestList[sender.tag].activity?.activityIn) != nil {
                 ...
                 // let lblin = arrGuestList[sender.tag].activity?.activityIn!.components(separatedBy:" ")[0]
                   ...
                   // let strIn = strChangeDateFormate_Multi(strDateeee: lblin!)
                    ...
                    popOverConfirmVC.strStartDate = strDate // strIn
                }
                ...
                if (arrGuestList[sender.tag].activity?.out) != nil {
                   ...
                   // let strOut = strChangeDateFormate_Multi(strDateeee: lblout!)
                    ...
                    popOverConfirmVC.StrEndDate = strDate // strOut
                }
            ...
            if arrGuestList[sender.tag].activity?.isMulti == "0" { // single
               ...
               if (arrGuestList[sender.tag].activity?.activityIn) != nil {
                  //  let activityIn = arrGuestList[sender.tag].activity?.activityIn!.components(separatedBy:" ")[0]
                    ...
                    popOverConfirmVC.strStartDate = strDate // activityIn!
                }
                ...
                if (arrGuestList[sender.tag].activity?.out) != nil {
                //  let out = arrGuestList[sender.tag].activity?.out!.components(separatedBy:" ")[0]
                    popOverConfirmVC.StrEndDate = strDate // out!
                }
                
                if (arrGuestList[sender.tag].activity?.allowedInTime) != nil {
                 // let activityIn = arrGuestList[sender.tag].activity?.allowedInTime!
                    popOverConfirmVC.strStartTime = strTime // activityIn!
                }
                
                if (arrGuestList[sender.tag].activity?.allowedOutTime) != nil {
                 // let out = arrGuestList[sender.tag].activity?.allowedOutTime!
                    popOverConfirmVC.strEndTime = strTime // out!
                }
           ...
           if (arrGuestList[sender.tag].activity?.activityIn) != nil {
            ...
            if arrGuestList[sender.tag].activity?.isMulti == "0" { // single
                ...
                popOverConfirmVC.isfrom = isfromNo // 33
    ...
    @objc func ApiCallEdit_OnDemand(sender:UIButton)
    {
        ...
        popOverConfirmVC.isfrom = isfromNo // 4
...
extension ActivityTabVC:UITableViewDelegate , UITableViewDataSource
{
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
     ...
     func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
       ...
       /* if arrGuestList[indexPath.row].userActivityID == "" || arrGuestList[indexPath.row].userActivityID == nil {
        } */
        
        if arrGuestList[indexPath.row].activity?.phone == "" || arrGuestList[indexPath.row].activity?.phone == nil {
       ...
       if (arrGuestList[indexPath.row].activity?.ActivityType != nil)  && (arrGuestList[indexPath.row].activity?.ActivityType  == "Visitor Entry") || (arrGuestList[indexPath.row].activity?.ActivityType  == "Visitor Pre-Approval") {
            
        
            cell.setVisitorEntry(activity: arrGuestList[indexPath.row].activity!, wrong: arrGuestList[indexPath.row])
              
       }
           
        else if (arrGuestList[indexPath.row].activity?.ActivityType == "Delivery Entry") || (arrGuestList[indexPath.row].activity?.ActivityType  == "Delivery Pre-Approval") {
            
            cell.setDeliveryEntry(activity: arrGuestList[indexPath.row].activity!, wrong: arrGuestList[indexPath.row])

        }

        else if (arrGuestList[indexPath.row].activity?.ActivityType! == "Service Provider Pre-Approval") || (arrGuestList[indexPath.row].activity?.ActivityType! == "Service Provider Entry") || (arrGuestList[indexPath.row].activity?.ActivityType  == "Cab Pre-Approval") || (arrGuestList[indexPath.row].activity?.ActivityType  == "Cab Entry") {
            
             cell.setService_CabEntry(activity: arrGuestList[indexPath.row].activity!, wrong: arrGuestList[indexPath.row])

        }
       
        else if (arrGuestList[indexPath.row].activity?.ActivityType == "Daily Helper") || (arrGuestList[indexPath.row].activity?.ActivityType == "Daily Helper Entry") || (arrGuestList[indexPath.row].activity?.ActivityType == "Add Daily Helper") {
            
            cell.setDailyEntry(activity: arrGuestList[indexPath.row].activity!, wrong: arrGuestList[indexPath.row])

        }
       
        else if (arrGuestList[indexPath.row].activity?.ActivityType == "OnDemand Helper") || (arrGuestList[indexPath.row].activity?.ActivityType == "OnDemand Entry") {
            
            cell.setOnDemandEntry(activity: arrGuestList[indexPath.row].activity!, wrong: arrGuestList[indexPath.row])

        }
       
        else if arrGuestList[indexPath.row].activity?.ActivityType == "Emergency Alert " {
            
            cell.setEmergencyAlert(activity: arrGuestList[indexPath.row].activity!, message: arrGuestList[indexPath.row])

        }
        
        else if arrGuestList[indexPath.row].activity?.ActivityType  == "Complaint to Guard" {
            
            cell.setComplaintToGuard(activity: arrGuestList[indexPath.row].activity!, message: arrGuestList[indexPath.row])

        }
        
        else if arrGuestList[indexPath.row].activity?.ActivityType  == "Message to Guard" {
            
            cell.setMessageToGuard(activity: arrGuestList[indexPath.row].activity!, message: arrGuestList[indexPath.row])

        }

        else if arrGuestList[indexPath.row].activity?.ActivityType  == "Vehicle Added" {
            
            cell.setVehicleAdded(activity: arrGuestList[indexPath.row].activity!, message: arrGuestList[indexPath.row])

        }

        else if arrGuestList[indexPath.row].activity?.ActivityType  == "Add Family Member" {
            
            cell.setAddFamilyMember(activity: arrGuestList[indexPath.row].activity!, message: arrGuestList[indexPath.row])

        }
         
        else if arrGuestList[indexPath.row].activity?.ActivityType  == "Remove Family Member" {
            
            cell.setRemoveFamilyMember(activity: arrGuestList[indexPath.row].activity!, message: arrGuestList[indexPath.row])

        }
         
        else{
            
            cell.setOtherCard(activity: arrGuestList[indexPath.row].activity!, message: arrGuestList[indexPath.row])
            ...
            cell.btnDeliveryInfo.tag = indexPath.item
            ...
            cell.btnRenew.addTarget(self, action:#selector(ApiCallRenew), for: .touchUpInside)
