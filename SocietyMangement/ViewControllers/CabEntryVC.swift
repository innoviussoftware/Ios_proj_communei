   ...
   /* func textFieldShouldReturn(_ textField: UITextField) -> Bool {
    ...
    func textFieldDidBeginEditing(_ textField: UITextField) {
        ...
        if(textField == txtCabCompanyName)
        {
            ...
            self.navigationController?.pushViewController(popOverConfirmVC, animated: false)
           ...
           // txtCabCompanyName.endEditing(true)
        ...
        if (textField == txtCabCompanyName1)
        {
           ...
           // pager.scrollView?.isPagingEnabled = false
                        
           // txtCabCompanyName1.endEditing(true)
